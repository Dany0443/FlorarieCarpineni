...
// unde sa redirectioneze cand este accesat
app.get('/', (req, res) => {
...
app.post('/api/submit-order', async (req, res) => {
  try {
    ...
    // configurarea transmiterea emailului
    ...
    // trimitere confirmare la clienti daca au introdus email
    if (email) {
